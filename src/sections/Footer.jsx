            ...
            <div className="flex items-center gap-5 mt-8">
              {
                socialMedia.map((icon, index) => {
                  return (
                  <div key={index} className="flex justify-center items-center size-12 bg-white rounded-full">
                ...
                <div className="" key={index} >
                  ...
                  <ul>
                  {
                    section.links.map((item, index) => {
                      return (
                        <li key={index} className="text-white mt-3 text-white-400 font-montserrat leading-normal text-balance cursor-pointer" >
                          <a href="">{item.name}</a>
                        </li>
                      )
                    })
